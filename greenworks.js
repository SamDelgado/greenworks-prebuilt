...
if (process.platform == 'darwin') {
  ...
  if (process.arch == 'x64') { greenworks = require('./lib/greenworks-win64.node'); } else if (process.arch == 'ia32') { greenworks = require('./lib/greenworks-win32.node'); }
} else if (process.platform == 'linux') {
  if (process.arch == 'x64') { greenworks = require('./lib/greenworks-linux64.node'); } else if (process.arch == 'ia32') { greenworks = require('./lib/greenworks-linux32.node'); }
}
